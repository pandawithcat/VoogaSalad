...
public class ButtonPanel extends VBox {
    ...
    public ButtonPanel(double width, double height, PlayInterface method, PlayInterface fastFoward, Stage stage){
        ...
        mySettingsPanel = new SettingsPanel(width, height/2, stage);
